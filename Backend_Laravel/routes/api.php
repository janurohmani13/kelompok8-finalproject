...
Route::get('/addresses/{userId}', [AddressController::class, 'show']);
Route::get('/payments/status/{transactionId}', [PaymentController::class, 'status']);
    ...
    Route::get('/receipt/{id}', [ReceiptController::class, 'show'])->name('receipt'); // Menampilkan struk
Route::get('/generate-receipt/{id}', [ReceiptController::class, 'generateReceiptImage']); // Mengonversi ke JPG
Route::get('api/transaction/{orderId}', [PaymentController::class, 'getTransactionDetails']);
...
// Route untuk serve file gambar dari storage
