        ...
        <nav class="bg-white border-b shadow p-4 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div class="text-xl font-bold text-[#5979f5] flex items-center gap-2">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="logo" class="w-10 h-10"
        ...
        <div class="flex flex-1 w-full h-full overflow-hidden">
            ...
            <aside id="sidebar"
                ...
                <nav class="mt-8 space-y-3 sidebar-links text-[15px]">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 hover:text-[#5979f5]">
                        <i class="fas fa-chart-line"></i><span>Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-2 hover:text-[#5979f5]">
                    ...
                    <a href="<?php echo e(route('admin.shipments.index')); ?>" class="flex items-center gap-2 hover:text-[#5979f5]">
                        <i class="fas fa-truck"></i><span>Pengiriman</span>
                    </a>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-2 hover:text-[#5979f5]">
...
<?php /**PATH C:\xampp\htdocs\Eccommerce\Trenz\resources\views/layouts/admin.blade.php ENDPATH**/ ?>